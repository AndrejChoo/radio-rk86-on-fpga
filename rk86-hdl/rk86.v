...
//Clock
wire CLK_28, CLK_50, CLK_250;

main_pll mpl(.inclk0(clk),.c0(CLK_28),.c1(CLK_50),.c2(CLK_250));
...
vg75 mvc(.pixclk(CLK_50),.hclk(CLK_250),.rst(rst),.tmds(tmds),.tmdsc(tmdsc),
						  .ADD(CPU_ADD),.DIN(CPU_DO),.WR(WM),.KURSOR(KURSOR));
